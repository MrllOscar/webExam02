...
<div>首頁　＞　分類網誌　＞<span id="show">　健康新知</span></div>
<button id="tag1" class="tag">健康新知</button>
<button id="tag2" class="tag">菸害防治</button>
<button id="tag3" class="tag">癌症防治</button>
<button id="tag4" class="tag">慢性病防治</button>

<fieldset>
<div class="b ttag" id="ttag1">缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%-(1)</br>缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%-(2)</div>
<div class="b ttag" id="ttag2">菸害防治法規-(1)</br>菸害防治法規-(2)</div>
<div class="b ttag" id="ttag3">降低罹癌風險 建構健康生活型態-(1)</br>降低罹癌風險 建構健康生活型態-(2)</div>
<div class="b ttag" id="ttag4">長期憋尿 泌尿系統問題多-(1)</br>長期憋尿 泌尿系統問題多-(2)</div>

<pre id="tttag1" class="b">
資料來源： 行政院衛生署國民健康局 
發佈日期： 2012 / 10 / 07
