...
<body>
  ...
  <div id="all">
    <div id="title">
      <?=date("m-d l")?> | 今日瀏覽: <?=$Total->find(['date'=>date("Y-m-d")])['total']?> | 累積瀏覽: <?=$Total->sum("total")?> <a href="/index.php" style="float:right">回首頁</a></div>
    <div id="title2">
        ...
        <div>
          ...
          <?php if(!isset($_SESSION['admin'])){ ?>
            ...
            <?php }else{
              ...
              歡迎，admin <a href="/backend.php">管理</a>|<a href="api/logout.php">登出</a>
              <?php }else{?>
              歡迎，<?=$_SESSION['admin']?> <a href="api/logout.php">登出</a>
          <?php }}?>
          </span>
          <div class="">
            <?php
