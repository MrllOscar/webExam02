...
<input type="button" id="t1" class="tag" value="健康新知">
<input type="button" id="t2" class="tag" value="菸害防治">
<input type="button" id="t3" class="tag" value="癌症防治">
<input type="button" id="t4" class="tag" value="慢性病防治">

<pre class="b" id="tt1">缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%
資料來源： 行政院衛生署國民健康局 
發佈日期： 2012 / 10 / 07
...
<pre class="b" id="tt3">降低罹癌風險 建構健康生活型態
...
<pre class="b" id="tt4">長期憋尿 泌尿系統問題多 
資料來源：中央健康保險局雙月刊第98期
上稿日期：2012/08/10
文／游小雯
