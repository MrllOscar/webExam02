...
<div>目前位置　＞　分類網誌　＞　<span class="word">健康新知</span></div>
<button id="tag1" class="t">健康新知</button>
<button id="tag2" class="t">菸害防治</button>
<button id="tag3" class="t">癌症防治</button>
<button id="tag4" class="t">慢性病防治</button>
<fieldset>
  <div id="ttag1" class="tt b">缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%-(1)<br>缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%-(2)</div>
  <div id="ttag2" class="tt b">菸害防治法規-(1)<br>菸害防治法規-(2)</div>
  <div id="ttag3" class="tt b">降低罹癌風險 建構健康生活型態-(1)<br>降低罹癌風險 建構健康生活型態-(2)</div>
  <div id="ttag4" class="tt b">長期憋尿 泌尿系統問題多-(1)<br>長期憋尿 泌尿系統問題多-(2)</div>
