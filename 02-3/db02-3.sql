...
(3, 'mem02', 'mem02', 'mem02@labor.gov.tw'),
(4, 'mem01', 'mem01', 'mem01@labor.gov.tw'),
(5, 'test', '5678', 'test@labor.gov.tw'),
(6, '123', '123', '123');
...
INSERT INTO `que` (`id`, `text`, `sh`, `MID`, `vote`) VALUES
(3, 'jp4wu6', 1, 0, 5),
(4, '測試', 1, 3, 1),
(5, '測試看看', 1, 3, 4),
(202, '問題一：你最常做什麼運動來促進健康體能呢?', 1, 0, 1),
(203, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1, 202, 0),
(204, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 1, 202, 0),
(205, '球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1, 202, 0),
(206, '舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 1, 202, 1),
(207, '問題二：二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?', 1, 0, 1),
(208, '增加罹患冠狀動脈心臟病及罹病死亡之風險。', 1, 207, 0),
(209, '對孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。', 1, 207, 0),
(210, '孕婦吸入二手菸易造成流產、早產、胎盤早期剝離、子宮感染等疾病。', 1, 207, 1),
(211, '長期的暴露會造成更嚴重的胸腔問題和過敏症，還會增加心臟病和肺癌的罹患率。', 1, 207, 0),
(212, '以上皆是。', 1, 207, 0);
...
INSERT INTO `vote` (`id`, `acc`, `vote`) VALUES
(1, 'admin', 1),
(2, 'admin', 3),
(3, 'admin', 13),
(633, 'admin', 7),
