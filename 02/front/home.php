...
<div>
<button id="t1" class="tag">健康新知</button>
<button id="t2" class="tag">菸害防治</button>
<button id="t3" class="tag">癌症防治</button>
<button id="t4" class="tag">慢性病防治</button>
</div>
<pre id="tt1" class="block">
  <h2>健康新知</h2>
