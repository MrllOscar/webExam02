      ...
      <div class="hal" id="main">
        <div>
          ...
          <?php
            if(isset($_SESSION['admin'])){
              if($_SESSION['admin']=='admin'){
                echo "歡迎，管理者".$_SESSION['admin']."<input type='button' value='管理'><a href='?do=logout'><input type='button' value='登出'></a>";
              }else{
          ...
          <div class="content">
            ...
            include_once file_exists($file)?$file:"frontend/home.php" ;
            ?>
