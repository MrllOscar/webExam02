...
<fieldset>
<legend>分類網誌</legend>
<div id="t1" class="tag">健康新知</div>
<div id="t2" class="tag">菸害防治</div>
<div id="t3" class="tag">癌症防治</div>
<div id="t4" class="tag">慢性病防治</div>
</fieldset>
<fieldset>
<legend>文章列表</legend>
<div id="tt1" class="ttag block">缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%-(1)<br>缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%-(2)</div>
<div id="tt2" class="ttag block">菸害防治法規-(1)<br>菸害防治法規-(2)</div>
<div id="tt3" class="ttag block">降低罹癌風險 建構健康生活型態-(1)<br>降低罹癌風險 建構健康生活型態-(2)</div>
<div id="tt4" class="ttag block">長期憋尿 泌尿系統問題多-(1)<br>長期憋尿 泌尿系統問題多-(2)</div>



<pre id="ttt1" class="block">
資料來源： 行政院衛生署國民健康局 
發佈日期： 2012 / 10 / 07
...
7. 減少看電視、打電玩等靜態生活的時間。
    民眾對運動如有疑問，可參考國民健康局肥胖防治網-「快樂動」(htttp://obesity.bhp.gov.tw)，亦可撥打免費市話健康體重管理電話諮詢服務，諮詢專線「0800-367-100（0800-瘦落去-要動動）」，也可利用國民健康局局網首頁或肥胖防治網問題諮詢專區的網路電話撥入功能，向客服人員諮詢關於運動、健康飲食及健康體重管理等相關疑問。</pre>
<pre id="ttt2" class="block">
